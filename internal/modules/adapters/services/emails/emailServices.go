...
type EmailServicesAdapter struct {
	// Puedes inicializar el cliente aquí si prefieres no hacerlo en cada llamada
}

func NewEmailServicesAdapter() *EmailServicesAdapter {
	return &EmailServicesAdapter{}
}

func (a *EmailServicesAdapter) SendOtpsEmail(data *command.AuthenticatedUserCommand, html string) (email.EntityEmailOtpResponse, error) {
